...
\pkuthssinfo{
	...
	ctitle = {高不可预测性PUF电路设计}, etitle = {Design methodology of Unpredictable Physical Unclonable Functions},
	cauthor = {唐文懿},
	eauthor = {Wenyi Tang},
	...
	ckeywords = {芯片安全，密码学，PUF，数字电路设计},
	ekeywords = {Physical Unclonable Function, Cryptography, chip security, digital circuit design}
}
